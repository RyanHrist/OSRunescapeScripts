...
public class Banking
{
    ...
    public boolean withdrawCoal() {
        for (Item i : script.bank.getItems()) {
            if (i.getName().equals("Coal")) {
                script.bank.withdraw("Coal", 18);
                return true;
            }
        }
        return false;
    ...
    public boolean withdrawIron() {
        for (Item i : script.bank.getItems()) {
            if (i.getName().equals("Iron ore")) {
                script.bank.withdraw("Iron ore", MethodProvider.random(9,15));
                return true;
            }
        }
        return false;
    ...
    public boolean withdrawCopper() {
        for (Item i : script.bank.getItems()) {
            if (i.getName().equals("Copper ore")) {
                script.bank.withdraw("Copper ore", 13);
                return true;
            }
        }
        return false;
    ...
    public boolean withdrawTin() {
        for (Item i : script.bank.getItems()) {
            if (i.getName().equals("Tin ore")) {
                script.bank.withdraw("Tin ore", 13);
                return true;
            }
        }
        return false;
